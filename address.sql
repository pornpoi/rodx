-- P_COUNTRY
CREATE TABLE public."P_COUNTRY" (
	"ID" varchar NOT NULL,
	"NAME_TH" varchar NOT NULL,
	"NAME_EN" varchar NOT NULL,
	"IMAGE" varchar NULL,
	CONSTRAINT "PK_08ebcfb1327838a6ccd0b227b8b" PRIMARY KEY ("ID")
);

INSERT INTO public."P_COUNTRY" ("ID","NAME_TH","NAME_EN","IMAGE") VALUES
	 ('1','ไทย','Thailand','public/images/thai.jpg');
	 
	
--P_PROVINCES
	CREATE TABLE public."P_PROVINCES" (
	"ID" varchar NOT NULL,
	"CODE" varchar NOT NULL,
	"NAME_TH" varchar NOT NULL,
	"NAME_EN" varchar NOT NULL,
	"GEOGRAPHY_ID" varchar NULL,
	"COUNTRY_ID" varchar NOT NULL,
	CONSTRAINT "PK_63e9003b54bbbf232fd294b3e0e" PRIMARY KEY ("ID"),
	CONSTRAINT "FK_60365537ea8f5fa3f5babd126f8" FOREIGN KEY ("COUNTRY_ID") REFERENCES public."P_COUNTRY"("ID")
);
	
	INSERT INTO public."P_PROVINCES" ("ID","CODE","NAME_TH","NAME_EN","GEOGRAPHY_ID","COUNTRY_ID") VALUES
	 ('1','10','กรุงเทพมหานคร','Bangkok','2','1'),
	 ('2','11','สมุทรปราการ','Samut Prakan','2','1'),
	 ('3','12','นนทบุรี','Nonthaburi','2','1'),
	 ('4','13','ปทุมธานี','Pathum Thani','2','1'),
	 ('5','14','พระนครศรีอยุธยา','Phra Nakhon Si Ayutthaya','2','1'),
	 ('6','15','อ่างทอง','Ang Thong','2','1'),
	 ('7','16','ลพบุรี','Loburi','2','1'),
	 ('8','17','สิงห์บุรี','Sing Buri','2','1'),
	 ('9','18','ชัยนาท','Chai Nat','2','1'),
	 ('10','19','สระบุรี','Saraburi','2','1');
INSERT INTO public."P_PROVINCES" ("ID","CODE","NAME_TH","NAME_EN","GEOGRAPHY_ID","COUNTRY_ID") VALUES
	 ('11','20','ชลบุรี','Chon Buri','5','1'),
	 ('12','21','ระยอง','Rayong','5','1'),
	 ('13','22','จันทบุรี','Chanthaburi','5','1'),
	 ('14','23','ตราด','Trat','5','1'),
	 ('15','24','ฉะเชิงเทรา','Chachoengsao','5','1'),
	 ('16','25','ปราจีนบุรี','Prachin Buri','5','1'),
	 ('17','26','นครนายก','Nakhon Nayok','2','1'),
	 ('18','27','สระแก้ว','Sa Kaeo','5','1'),
	 ('19','30','นครราชสีมา','Nakhon Ratchasima','3','1'),
	 ('20','31','บุรีรัมย์','Buri Ram','3','1');
INSERT INTO public."P_PROVINCES" ("ID","CODE","NAME_TH","NAME_EN","GEOGRAPHY_ID","COUNTRY_ID") VALUES
	 ('21','32','สุรินทร์','Surin','3','1'),
	 ('22','33','ศรีสะเกษ','Si Sa Ket','3','1'),
	 ('23','34','อุบลราชธานี','Ubon Ratchathani','3','1'),
	 ('24','35','ยโสธร','Yasothon','3','1'),
	 ('25','36','ชัยภูมิ','Chaiyaphum','3','1'),
	 ('26','37','อำนาจเจริญ','Amnat Charoen','3','1'),
	 ('27','39','หนองบัวลำภู','Nong Bua Lam Phu','3','1'),
	 ('28','40','ขอนแก่น','Khon Kaen','3','1'),
	 ('29','41','อุดรธานี','Udon Thani','3','1'),
	 ('30','42','เลย','Loei','3','1');
INSERT INTO public."P_PROVINCES" ("ID","CODE","NAME_TH","NAME_EN","GEOGRAPHY_ID","COUNTRY_ID") VALUES
	 ('31','43','หนองคาย','Nong Khai','3','1'),
	 ('32','44','มหาสารคาม','Maha Sarakham','3','1'),
	 ('33','45','ร้อยเอ็ด','Roi Et','3','1'),
	 ('34','46','กาฬสินธุ์','Kalasin','3','1'),
	 ('35','47','สกลนคร','Sakon Nakhon','3','1'),
	 ('36','48','นครพนม','Nakhon Phanom','3','1'),
	 ('37','49','มุกดาหาร','Mukdahan','3','1'),
	 ('38','50','เชียงใหม่','Chiang Mai','1','1'),
	 ('39','51','ลำพูน','Lamphun','1','1'),
	 ('40','52','ลำปาง','Lampang','1','1');
INSERT INTO public."P_PROVINCES" ("ID","CODE","NAME_TH","NAME_EN","GEOGRAPHY_ID","COUNTRY_ID") VALUES
	 ('41','53','อุตรดิตถ์','Uttaradit','1','1'),
	 ('42','54','แพร่','Phrae','1','1'),
	 ('43','55','น่าน','Nan','1','1'),
	 ('44','56','พะเยา','Phayao','1','1'),
	 ('45','57','เชียงราย','Chiang Rai','1','1'),
	 ('46','58','แม่ฮ่องสอน','Mae Hong Son','1','1'),
	 ('47','60','นครสวรรค์','Nakhon Sawan','2','1'),
	 ('48','61','อุทัยธานี','Uthai Thani','2','1'),
	 ('49','62','กำแพงเพชร','Kamphaeng Phet','2','1'),
	 ('50','63','ตาก','Tak','4','1');
INSERT INTO public."P_PROVINCES" ("ID","CODE","NAME_TH","NAME_EN","GEOGRAPHY_ID","COUNTRY_ID") VALUES
	 ('51','64','สุโขทัย','Sukhothai','2','1'),
	 ('52','65','พิษณุโลก','Phitsanulok','2','1'),
	 ('53','66','พิจิตร','Phichit','2','1'),
	 ('54','67','เพชรบูรณ์','Phetchabun','2','1'),
	 ('55','70','ราชบุรี','Ratchaburi','4','1'),
	 ('56','71','กาญจนบุรี','Kanchanaburi','4','1'),
	 ('57','72','สุพรรณบุรี','Suphan Buri','2','1'),
	 ('58','73','นครปฐม','Nakhon Pathom','2','1'),
	 ('59','74','สมุทรสาคร','Samut Sakhon','2','1'),
	 ('60','75','สมุทรสงคราม','Samut Songkhram','2','1');
INSERT INTO public."P_PROVINCES" ("ID","CODE","NAME_TH","NAME_EN","GEOGRAPHY_ID","COUNTRY_ID") VALUES
	 ('61','76','เพชรบุรี','Phetchaburi','4','1'),
	 ('62','77','ประจวบคีรีขันธ์','Prachuap Khiri Khan','4','1'),
	 ('63','80','นครศรีธรรมราช','Nakhon Si Thammarat','6','1'),
	 ('64','81','กระบี่','Krabi','6','1'),
	 ('65','82','พังงา','Phangnga','6','1'),
	 ('66','83','ภูเก็ต','Phuket','6','1'),
	 ('67','84','สุราษฎร์ธานี','Surat Thani','6','1'),
	 ('68','85','ระนอง','Ranong','6','1'),
	 ('69','86','ชุมพร','Chumphon','6','1'),
	 ('70','90','สงขลา','Songkhla','6','1');
INSERT INTO public."P_PROVINCES" ("ID","CODE","NAME_TH","NAME_EN","GEOGRAPHY_ID","COUNTRY_ID") VALUES
	 ('71','91','สตูล','Satun','6','1'),
	 ('72','92','ตรัง','Trang','6','1'),
	 ('73','93','พัทลุง','Phatthalung','6','1'),
	 ('74','94','ปัตตานี','Pattani','6','1'),
	 ('75','95','ยะลา','Yala','6','1'),
	 ('76','96','นราธิวาส','Narathiwat','6','1'),
	 ('77','97','บึงกาฬ','buogkan','3','1');
	
	-- P_AMPHURES
	 CREATE TABLE public."P_AMPHURES" (
	"ID" varchar NOT NULL,
	"CODE" varchar NOT NULL,
	"NAME_TH" varchar NOT NULL,
	"NAME_EN" varchar NOT NULL,
	"PROVINCE_ID" varchar NOT NULL,
	CONSTRAINT "PK_1e142a30dc3a2db96ab30f93789" PRIMARY KEY ("ID"),
	CONSTRAINT "FK_8340dd090628ab12090ac767dd7" FOREIGN KEY ("PROVINCE_ID") REFERENCES public."P_PROVINCES"("ID")
);
INSERT INTO public."P_AMPHURES" ("ID","CODE","NAME_TH","NAME_EN","PROVINCE_ID") VALUES
...
INSERT INTO public."P_AMPHURES" ("ID","CODE","NAME_TH","NAME_EN","PROVINCE_ID") VALUES
	...
	-- P_DISTRICTS
	CREATE TABLE public."P_DISTRICTS" (
	"ID" varchar NOT NULL,
	"ZIP_CODE" varchar NOT NULL,
	"NAME_TH" varchar NOT NULL,
	"NAME_EN" varchar NOT NULL,
	"AMPHURE_ID" varchar NOT NULL,
	CONSTRAINT "PK_863ece4cd134dc97f0f00bfaeac" PRIMARY KEY ("ID"),
	CONSTRAINT "FK_b4bed137246778be1812cb83c57" FOREIGN KEY ("AMPHURE_ID") REFERENCES public."P_AMPHURES"("ID")
);


INSERT INTO public."P_DISTRICTS" ("ID","ZIP_CODE","NAME_TH","NAME_EN","AMPHURE_ID") VALUES
